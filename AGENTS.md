...
A **Bitfocus Companion connection module** for **PDF Presenter Lite**. It lets a running
...
```
Companion surface  ──▶  this module  ──UDP OSC 35551──▶  PDF Presenter Lite
...
- **The protocol is owned by [`pdf-presenter-lite`](https://github.com/stoatworks-labs/pdf-presenter-lite), not by this repo.**
...
| Repo | Controls |
|---|---|
| **companion-module-pdf-presenter-lite** (this) | PDF Presenter Lite |
