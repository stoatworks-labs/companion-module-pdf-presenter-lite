...
— *and* make sure the app's own OSC settings panel has its **Feedback host** pointing back at the
...
> not provide. If you need a button to *look* like it knows, drive it from the slideshow state
> instead.
